...
RSpec.describe "Crafting Doubles" do
    ...
    it "sets up a double with methods" do
      # Set up your doubles here
      fake_object = double :fake_obj, speak: "Meow", count_ears: 2, count_legs: 4 # ...
      # or use long method as:
        # fake_object = double :fake_obj
